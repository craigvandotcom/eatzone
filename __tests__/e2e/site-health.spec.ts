...
test.describe('Site Health', () => {
  ...
  test('home page loads correctly', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /your body.*compass/i }).first()).toBeVisible();
    ...
    const ctaVisible = await page.getByRole('link', { name: /start tracking|get started/i }).first().isVisible();
  ...
  test('responsive design works on mobile', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /your body.*compass/i }).first()).toBeVisible();
    const mobileCta = await page.getByRole('link', { name: /start tracking|get started/i }).first().isVisible();
