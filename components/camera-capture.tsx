...
export function CameraCapture({ open, onOpenChange, onCapture, onManualEntry, title }: CameraCaptureProps) {
        ...
        <div className="relative">
          ...
          <div className="p-4">
            <div className="flex gap-3">
              ...
              <Button onClick={handleManualEntry} variant="outline" className="flex-1" size="lg">
