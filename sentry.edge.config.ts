...
// Note that this config is unrelated to the Vercel Edge Runtime and is also applied to locally-run edge features.
...
Sentry.init({
  ...
  beforeSend(event, hint) {
    ...
    // Remove sensitive data from request data (important for middleware)
